...
class config{
 ...
 public:
  ...
  //******in c_cl.cpp*****************
  double ClCl(particle*, particle*);
  double ClClCl(particle*, particle*, particle*);
  //******in c_sif.cpp***************
  double FSi(particle*, particle*);
  double FSiSi(particle*, particle*, particle*);
  double FFSi(particle*, particle*, particle*);
  //******in c_sicl.cpp***************
  double ClSi(particle*, particle*);
  double ClSiSi(particle*, particle*, particle*);
  double ClClSi(particle*, particle*, particle*);
  //******in c_mo.cpp****************
  ...
  double HeCl(particle*, particle*);
  double NeCl(particle*, particle*);
  double ArCl(particle*, particle*);
  //******in c_io.cpp****************
  void Load(string);
  void Dump();
  //******in c_ion.cpp***************
  ...
  double FindWell(short,svector*);
  double U_on_i(VPI,float);
  //******in c_top.cpp**************
  double AvgTop();
  //******in c_uonly.cpp************
  double u_SiSi();
